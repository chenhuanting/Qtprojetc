...
QT_MOC_LITERAL(3, 13, 9) // "writeData"

    },
    "Motor\0start\0\0writeData"
};
...
void Motor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Motor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Motor::start)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Motor::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Motor::writeData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Motor::writeData(const QByteArray & _t1)
{
